...
$confpassword=base64_encode($_POST["confirm_password"]);
...
else
{
   ...
   try {
    ...
    $mail->Body    = 'Welcome '. $name.' , your registration is done successfully in <b>Fortune Physical Fitness Centre.</b> <br/><br/>
                      Registered MailId - '.$email.'<br/><br/>Password is - '.$_POST["password"].'<br/><br/>Your Membership is - '.$membership.'<br/><br/>Have a Nice Day !!';
    ...
    echo '<script>
       ...
       window.location="register_frontend.php";
    </script>';
}
